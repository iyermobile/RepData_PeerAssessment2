...
### By GITHUB - IYERMOBILE

## Severe Weather Event's impact on Public Health and Economy in the United States
...
```r
if (!"stormData" %in% ls()) {
    stormData <- read.csv("repdata-data-StormData/repdata-data-StormData.csv", sep = ",")
}
dim(stormData)
```
